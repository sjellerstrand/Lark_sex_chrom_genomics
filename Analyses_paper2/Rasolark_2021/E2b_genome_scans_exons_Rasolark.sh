...
# Create folders
mkdir $OUTDIR0/E2b_genome_scans_exons;
OUTDIR0=$OUTDIR0/E2b_genome_scans_exons;
...
for DATA in $DATASETS; do
  ...
  ### Prepare BED files
  bedtools slop -i $EXONS -g $REF.fai -b 0 | bedtools merge \
  > $OUTDIR0/Reuseable_files/exons.bed;
  bedtools intersect -a $BEDS/$PROJECT\_$DATA.bed \
  -b $OUTDIR0/Reuseable_files/exons.bed \
