...
## RELAX1
colnames(data_rel1) <- c("geneID", "SexLinked_RELAX1_p.WvsZ1", "SexLinked_RELAX1_K.WvsZ", "SexLinked_RELAX1_p.WvsZ2")          
data_rel1 <- data_rel1[,c("geneID", "SexLinked_RELAX1_K.WvsZ", "SexLinked_RELAX1_p.WvsZ1", "SexLinked_RELAX1_p.WvsZ2")]
...
## RELAX2
colnames(data_rel2) <- c("geneID", "SexLinked_RELAX2_p.ZWvsA1", "SexLinked_RELAX2_K.ZWvsA", "SexLinked_RELAX2_p.ZWvsA2")          
data_rel2 <- data_rel2[,c("geneID", "SexLinked_RELAX2_K.ZWvsA", "SexLinked_RELAX2_p.ZWvsA1", "SexLinked_RELAX2_p.ZWvsA2")]
