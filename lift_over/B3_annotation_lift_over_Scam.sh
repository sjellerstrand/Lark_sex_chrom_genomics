...
SPEC_name=Scam;
SPEC0=$MAINDIR/data/reference/Struthio_camelus\
/Struthio_camelus.20130116.OM.fasta;
...
### Create folders
mkdir $OUTDIR/B3_annotation_lift_over_Scam;
OUTDIR=$OUTDIR/B3_annotation_lift_over_Scam;
