...
SPEC_name=Falb;
SPEC0=$MAINDIR/data/reference/Ficedula_albicollis\
/GCA_000247815.2_FicAlb1.5_genomic.fasta;
...
### Create folders
mkdir $OUTDIR/B3_annotation_lift_over_Falb;
OUTDIR=$OUTDIR/B3_annotation_lift_over_Falb;
